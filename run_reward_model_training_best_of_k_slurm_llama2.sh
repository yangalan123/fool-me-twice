...
# --- do not uncomment beyond --
#conda activate /home/chenghao/env37
#conda activate /net/scratch/chenghao/env_py310
...
#--test_file ${root_dir}/${domain}/test_w_summary.json \
      ...
      #--output_dir ./agent_training_output_epoch3_filter_chain_rest_train${suffix}/city/${domain}
          ...
          #--label_column rank \
    output_dir=${output_root_dir}/${domain}/agent_difference_dataset/validation_set_llama2_lora_agent_training_output_epoch${epoch}${suffix}
    if [[ ! -f ${output_dir}/pytorch_model.bin ]]; then
        deepspeed --master_port 6100${SLURM_ARRAY_TASK_ID} agent_training_slurm.py \
          --model_name_or_path /net/scratch/chenghao/LLAMA2_hf/llama_7B \
          --do_train \
          --do_eval \
          --do_predict \
