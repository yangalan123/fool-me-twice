...
for SLURM_ARRAY_TASK_ID in 0 1 2 3 4 5 6 7
do
  ...
  python compute_best_of_k_performance_trainer.py \
  ...
  deepspeed --master_port 6100${SLURM_ARRAY_TASK_ID} compute_best_of_k_performance_trainer.py \
      --target_summary_dir ${target_summary_dir} \
      --base_model_dir ${base_model_dir} \
      --agent_model ${agent_model_dir} \
      --reward_model ${reward_model_dir} \
