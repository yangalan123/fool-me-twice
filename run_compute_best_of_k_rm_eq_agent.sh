...
# currently (06/04/2023), our summary is pretty general and not specific to any domain
...
# currently (06/04/2023), our agent model is pretty general (trained on gold evidence) and not specific to any domain
agent_model_dir="${model_root_dir}/dbt_agent_training_output_epoch${origin_epoch}${suffix}"
#reward_model_dir="${output_root_dir}/{}/dbt_agent_training_output_epoch${origin_epoch}${suffix}"
# currently (06/04/2023), our reward model is pretty general (trained on gold evidence) and not specific to any domain
reward_model_dir="${model_root_dir}/dbt_agent_training_output_epoch${origin_epoch}${suffix}"
...
#agent_model_dir="${output_root_dir}/${domain}/agent_difference_dataset/dbt_agent_training_output_epoch${origin_epoch}${suffix}"
