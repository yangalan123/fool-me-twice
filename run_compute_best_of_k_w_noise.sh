...
#reward_model_dir="${root_dir}/{}/agent_difference_dataset/validation_set_dbt_agent_training_output_epoch${rm_epoch}${suffix}_w_noise_training"
reward_model_dir="${root_dir}/${domain}/agent_difference_dataset/validation_set_dbt_agent_training_output_epoch${rm_epoch}${suffix}_w_noise_training"
...
python compute_best_of_k_performance.py \
    ...
    --exp_name "_rm_trained_for_difference_w_noise" \
