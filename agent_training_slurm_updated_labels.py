...
def main():
    ...
    if data_args.task_name is not None:
        ...
        if is_regression:
            ...
            # [update-ych]: trick to make it work for zero-shot classification on fm2
            if data_args.dataset_name is None:
                label_list.append("neurtal")
    ...
    if data_args.task_name is not None:
        ...
        if "sentence1" in non_label_column_names and "sentence2" in non_label_column_names:
            ...
            if "fever" in data_args.dataset_name:
    ...
    if (
        ...
        #[update-ych]: trick to make it work on FM2
        if data_args.dataset_name is None or "fever" not in data_args.dataset_name:
            if data_args.dataset_name is None:
    ...
    def preprocess_function(examples):
        ...
        if data_args.dataset_name is not None and "fever" in data_args.dataset_name:
    ...
    def compute_metrics(p: EvalPrediction):
        ...
        if data_args.task_name is not None:
            ...
            #[update-ych]: trick to get NLI model work for zero-shot fm2
            preds[preds==1] = 2
    ...
    if training_args.do_predict:
        ...
        for predict_dataset, task in zip(predict_datasets, tasks):
            ...
            predict_dataset = predict_dataset.remove_columns(data_args.label_column)
